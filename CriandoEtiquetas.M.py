...
while x in s:
    ...
    if tipo == 1:
        ...
        while valid_vara1 == False:
            print()
            vara = input("Especifique o número da Vara ou digite 'c' caso não necessite de uma vara especifica: ").lower()
            print()
            try:
                vara = str(vara)
                if vara not in lista_vara:
                    print("===" * 35)
                    print(
                        "Erro na entrada de dados, Ultilize somente números ou 'c' caso não precise de uma vara especifica.")
                    print("===" * 35)
                else:
                    valid_vara1 = True
            except:
        ...
        while valid_vara1 == False:
            print()
            vara = input("Especifique o numero da Vara ou digite 'c' caso não necessite de uma vara especifica: ").lower()
            print()
            try:
                vara = str(vara)
                if vara not in lista_vara:
